...
const UseEffectBasics=()=>{
    ...
    },[value]) // useEffect will be invoked only once when an empty array is passed as second parameter
    // if parameter passed in array then the useEffect will invoke each time when the paramter changes
